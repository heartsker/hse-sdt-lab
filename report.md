...
Для создания программы был использован язык программирования Python и библиотеки `transformers`, `torch`, `flask` и `flask-socketio`.

Программа состоит из двух частей: серверной и клиентской.

Серверная часть программы представляет собой веб-сервер, который обрабатывает запросы от клиентской части программы и возвращает ответы на вопросы, заданные в естественном языке.
...
2. **Култышкина Дарья**
    ...
    **Вклад**
    ...
    - Покрытие тестами проекта и проведение модульного, веб, нагрузочного, GUI тестирования
